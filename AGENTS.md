...
This file is the quick-reference operating contract for predicates-kotlin. The longer
...
predicates-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`predicates`](https://crates.io/crates/predicates). Upstream Rust is the behavioral oracle while the
