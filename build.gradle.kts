...
kotlin {
    ...
    val xcf = XCFramework("Predicates")

    macosArm64 {
        binaries.framework { baseName = "Predicates"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Predicates"; xcf.add(this) }
    }
    ...
    swiftExport {
        ...
        flattenPackage = "io.github.kotlinmania.predicates"
    }

    android {
        namespace = "io.github.kotlinmania.predicates"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "predicates-kotlin", version.toString())

    pom {
        name.set("predicates-kotlin")
        description.set("Kotlin Multiplatform port of assert-rs/predicates-rs - An implementation of boolean-valued predicate functions")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/predicates-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/predicates-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/predicates-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/predicates-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.predicates.codeql
